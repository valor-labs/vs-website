...
export const vacancies: any[] = [
  ...
  },
  {
    ...
    description: [
      'Valor Software is looking for a Business Analyst to join a company to work on a new and existing in-house projects. Core of the project is a Human Capital Management platform to optimize professional assessment in medium and big companies.',
  ...
  },
  {
    vacancyId: 9,
    show: true,
    name: 'Middle +  DevOps Vacancy',
    description: [
      'Valor Software is looking for an experienced Middle DevOps Engineer to help automate platform/application builds for both internal and external products. As a DevOps engineer, you will be responsible for managing our software and cloud-based infrastructure. We are in search of someone who can write the code that automatically deploys software and configures it appropriately. This is an extremely hands-on and engaging role with lots of responsibility, interesting challenges, and exposure to cutting-edge tech.',
      'As part of our team, you will have the opportunity to grow your career, contribute your ideas to life-changing products and services, and—above all—have fun doing it.'
    ],
    responsibilities: [
    ...
    requirements: [
      '4+ years of experience in administering / IT;',
      '2+ years of experience as DevOps;',
      'Experience in  administering Linux / UNIX / Windows systems;',
